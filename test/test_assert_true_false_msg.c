...
CESTER_TEST(test_assert_true_msg, test_instance, 
    ...
    cester_assert_true_msg(test_instance != NULL, "the test_instance must have been initialized"); 
...
CESTER_TEST(test_assert_false_msg, test_instance, 
    ...
    cester_assert_false_msg(test_instance == NULL, "The test instance is NULL? sure no"); 
)
